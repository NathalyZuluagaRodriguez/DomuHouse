...
const registerAgent = async (req: Request, res: Response) => {
  try {
    ...
    const { nombre,apellido, email, telefono, password, inmobiliariaId, id_rol } = req.body;
    const agente = new Agent(nombre,apellido, email, telefono, password, inmobiliariaId, id_rol);
